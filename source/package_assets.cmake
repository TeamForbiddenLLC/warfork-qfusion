if (${CMAKE_SYSTEM_NAME} MATCHES "Windows")
  execute_process (COMMAND cmd /c "7z a ${BIN_DIR}/basewf/data0_000_21.pk3 -r" WORKING_DIRECTORY "${ASSET_ROOT}/data0_000_21/")
  execute_process (COMMAND cmd /c "7z a ${BIN_DIR}/basewf/data0_000_21pure.pk3 -r" WORKING_DIRECTORY "${ASSET_ROOT}/data0_000_21pure/")
  execute_process (COMMAND cmd /c "7z a ${BIN_DIR}/basewf/data0_21.pk3 *" WORKING_DIRECTORY "${ASSET_ROOT}/data0_21/")
  execute_process (COMMAND cmd /c "7z a ${BIN_DIR}/basewf/data0_21pure.pk3 -r" WORKING_DIRECTORY "${ASSET_ROOT}/data0_21pure/")
  execute_process (COMMAND cmd /c "7z a ${BIN_DIR}/basewf/data1_21pure.pk3 -r" WORKING_DIRECTORY "${ASSET_ROOT}/data1_21pure/")
else()
